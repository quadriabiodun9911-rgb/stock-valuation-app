...
const SLIDES = [
    {
        ...
        subtitle: 'AI-powered valuations, DCF models, and technical analysis — all in one place.',
        gradient: ['#0f172a', '#1e3a5f'] as const,
        accent: '#3b82f6',
        features: ['DCF & FCF Valuation', 'Technical Indicators', 'Peer Comparison'],
    },
    {
        id: '2',
        icon: 'swap-horizontal' as const,
        title: 'Practice Risk-Free',
        subtitle: 'Paper trade with our simulator. Test strategies before investing real money.',
        gradient: ['#0f172a', '#1a3329'] as const,
        accent: '#16a34a',
        features: ['Paper Trading Simulator', 'Portfolio Tracking', 'Performance Analytics'],
    },
    {
        id: '3',
        icon: 'people' as const,
        title: 'Learn Together',
        subtitle: 'Join a community of investors. Share insights, discuss strategies, and grow your wealth.',
        gradient: ['#0f172a', '#2d1b4e'] as const,
        accent: '#7c3aed',
        features: ['Social Feed & Chat', 'Trade Reasoning', 'Crowd Intelligence'],
    },
];
